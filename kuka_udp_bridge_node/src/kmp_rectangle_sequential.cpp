...
public:
    KmpRectangleSequential() : Node("kmp_rectangle_sequential"), current_step_(0), current_state_(State::WAITING_FOR_INIT) {
        ...
        waypoints_ = {
            {1.0, 0.0, 90.0,   {0.0, 40.0, 0.0, -80.0, 0.0, 60.0, 50.0}},
            {1.0, 1.0, 0.0,   {0.0, 60.0, 0.0, -60.0, 30.0, 45.0, 0.0}},
            {0.0, 1.0, 0.0,   {30.0, 30.0, 10.0, -75.0, 0.0, 30.0, 0.0}},
            {0.0, 0.0, 90.0,   {0.0, 0.0, 0.0, -90.0, 0.0, 0.0, 0.0}}
        };
